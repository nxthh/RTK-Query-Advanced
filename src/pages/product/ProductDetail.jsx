...
const ProductDetail = () => {
  ...
  return (
    <div className="2xl:container 2xl:mx-auto lg:px-20  md:px-6 px-4 my-26 ">
      <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
        {/* <!-- Description Div --> */}
        <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
          <p className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-zinc-800 font-normal text-base leading-4 text-zinc-600 dark:text-zinc-300">
            {data?.category?.name}
          </p>
          <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-zinc-800 dark:text-zinc-100 mt-4">
            {data?.name}
          </h2>
          ...
          <div className="lg:mt-11 mt-10">
            ...
            <div className=" flex flex-row justify-between items-center mt-4">
              ...
              <svg
                ...
                id="rotateSVG"
                className={
                  "focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-zinc-800 cursor-pointer transform " +
        ...
        <div className=" w-full sm:w-96 md:w-8/12  lg:w-5/12 flex lg:flex-row flex-col flex-grow-1 lg:gap-4 sm:gap-6 gap-4">
          <div className="p-2 w-full rounded-2xl lg:w-full bg-zinc-100 flex justify-center items-center">
            <img
